...
ROOT=Path('/Users/qiuzhipeng/Downloads/ICASSP/enhancement_assessment_20260920');R=ROOT/'results'
checks={}
def sha(p):
 h=hashlib.sha256()
 with p.open('rb') as f:
...
Path('/Users/qiuzhipeng/Downloads/ICASSP/mechanism_assessment_20260920/qa/REUSED_EVIDENCE_VERIFICATION.json').write_text(json.dumps(dict(status='PASS',checks=checks),indent=2))
